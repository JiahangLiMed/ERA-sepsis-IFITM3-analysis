# =========================================================================
# Q1 顶刊定稿版：112 种机器学习大逃杀 (修复重制版)
# =========================================================================
# 修复内容：
#   1. 使用修复后的 Z-score 标准化数据（GSE69528 & GSE63042 已修正）
#   2. 保持秩转换策略确保跨平台稳健性
#   3. GSE63042 标注为 SIRS vs Sepsis
#   4. 保留原图风格：ComplexHeatmap 三段式热图 + 右侧柱状图 + ROC 曲线
#   5. 增加训练集类别不平衡处理（class weight）
# =========================================================================
